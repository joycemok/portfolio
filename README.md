...
|------------|----|-------------------|
|[Coffee Bean Sales](https://github.com/joycemok/SQL/tree/main/Coffee_Bean_Sales)|Business Analytics, Database Querying, Data Visualizations, Data Wrangling | Used MySQL to query and extract business insights from a coffee company database. Found business insights in regards to product preferences, revenue and profit, and sales by country. Created a Tableau [dashboard](https://public.tableau.com/app/profile/joyce.mok/viz/CoffeeBeanSales_17102333378460/CoffeeBeanSales) to visualize insights. The project is published [here](https://medium.com/@joycemok8/coffee-bean-sales-a4b4b442ba82). | 
|[My 2023 Spotify Data](https://github.com/joycemok/SQL/tree/main/my_2023_spotify_data)| Database Querying, Data Visualiation, Data Wrangling, Data Transformation | Using the json files requested from Spotify containing my personal streaming history for 2023, I used MySQL to prepared the files into working datasets. After merging and preparing the datasets, I used MySQL to query the data to answer questions about my spotify streaming history such as my top artists of the year and to analyze my listening trends. Connected MySQL queries to Tableau to build a [dashboard](https://public.tableau.com/views/My_spotify_data_dashboard/My2023SpotifyDataDashboard?:language=en-US&:display_count=n&:origin=viz_share_link) to visualize my findings. The project is published [here](https://medium.com/@joycemok8/my-spotify-2023-listening-habits-466a812cb2df).|
...
|------------|----|-------------------|
|[Coffee Bean Sales](https://public.tableau.com/app/profile/joyce.mok/viz/CoffeeBeanSales_17102333378460/CoffeeBeanSales)| March 2023 | Used MySQL to extract business insights regarding coffee bean revenue and profit as well as customer product preferences. Created a Tableau dashboard to visualize business insights. |
